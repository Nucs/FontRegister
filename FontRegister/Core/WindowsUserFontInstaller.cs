...
public class WindowsUserFontInstaller : IFontInstaller
{
    ...
    /// <summary>
    /// Installs a font file for the current user.
    /// </summary>
    ...
    public bool InstallFont(string fontPath)
    {
        ...
        try
        {
            ...
            using (var currentVersion = Registry.CurrentUser.OpenSubKey(FontConsts.ParentFontRegistryKey))
            {
            ...
            using (var fontsKey = Registry.CurrentUser.OpenSubKey(FontConsts.FontRegistryKey, true)!)
            {
                if (fontsKey == null)
                {
    ...
    /// <summary>
    /// Uninstalls a font from the current user's installed fonts.
    /// </summary>
